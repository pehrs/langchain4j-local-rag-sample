package com.pehrs.langchain4j.metrics;
...
public class ConsoleTableReporter extends ScheduledReporter implements Closeable {
  ...
  public static class Builder {
    ...
    public Builder histogramScaleFactor(String name, Double scale) {
      this.histogramScaleFactor.put(name, scale);
      return this;
    }

    public Builder showZeroMetrics(boolean showZeroMetrics) {
